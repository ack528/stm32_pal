...
//		Handle->speed1 = PAL_IIRFilter_Calc(&Handle->Encoder1_lpf, encoder1Change) * Handle->k / Handle->Init.Encoder.SampleInterval * 1000.0;
//		Handle->speed2 = PAL_IIRFilter_Calc(&Handle->Encoder2_lpf, encoder2Change) * Handle->k / Handle->Init.Encoder.SampleInterval * 1000.0;
		Handle->speed1 = encoder1Change * Handle->k;
		Handle->speed2 = encoder2Change * Handle->k;
		
		//App_Log_Printf("$%f %f;", Handle->speed1, Handle->speed2);
